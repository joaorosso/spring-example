...
public class PacienteController {
    ...
    @PutMapping
    @Transactional
    public ResponseEntity atualizar(@RequestBody @Valid DadosAlteracaoPaciente dados) {
    ...
    @GetMapping
    public ResponseEntity<Page<DadosListagemPaciente>> list(Pageable paginacao) {
